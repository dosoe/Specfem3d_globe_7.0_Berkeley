...
!
  ...
  case( 1 )
    ...
    ! DEBUG <SA>
    print*, '[create_regions_mesh] before indexing', ipass
...
! creates the different regions of the mesh
  ...
  do ilayer_loop = ifirst_region,ilast_region
    ...
    ! if (myrank .eq. 0 .and. ispec < 10) then
    !    print*, '[create_regular_elements]', myrank,ilayer,ichunk,ispec,ipass, &
    ...
    !         idoubling,doubling_index,USE_ONE_LAYER_SB, &
