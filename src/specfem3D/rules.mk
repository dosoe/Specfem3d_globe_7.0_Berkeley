...
specfem3D_OBJECTS += \
	...
	$O/bspline_compression.solverstatic_module.o \
...
specfem3D_MODULES = \
	...
	$(FC_MODDIR)/bspline_compression.$(FC_MODEXT) \
...
# $O/bspline_compression.solverstatic_module.o: $O/
...
$O/comp_source_time_function.solver.o: $O/bspline_compression.solverstatic_module.o $O/ucb_heaviside.solverstatic_module.o 

$O/get_force.o: $O/bspline_compression.solverstatic_module.o
